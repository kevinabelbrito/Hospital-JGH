...
<h1 id="titulo"><span class="icon-stethoscope"></span>Historial de Mortalidad</h1>
<form action="<?= base_url() ?>mortalidad/buscar" id="busqueda" method="post">
    <table id="formulario">
        <tr>
...
<table id="lista">
   ...
   <?php foreach ($muertes as $muerto):?>
   <tr>
        <td><?= $muerto['nombre']; ?></td>
        <td>
          <?php
          $fenac = date("Y-m-d 0:0:0", strtotime($muerto['fenac']));
          $feocu = date("Y-m-d h:i:s", strtotime($muerto['feocu']));
          ?>
          <?= timespan(human_to_unix($fenac) , human_to_unix($feocu), 1); ?>
        </td>
        <td><?= $muerto['sexo']; ?></td>
        <td><?= $muerto['indigena']; ?></td>
        <td><?= $muerto['municipio']; ?></td>
        <td><?= date("d-m-Y h:i a", strtotime($muerto['feocu'])); ?></td>
        <td>
            <a href="<?= base_url() ?>mortalidad/detalles/<?= $muerto['id']; ?>" title="Detalles"><span class="icon-wallet"></span></a>
            <a href="<?= base_url() ?>mortalidad/editar/<?= $muerto['id']; ?>" title="Editar"><span class="icon-pencil"></span></a>
            <?php if($this->session->userdata('tipo') == "Administrador"): ?>
            <a href="<?= base_url() ?>mortalidad/borrar/<?= $muerto['id']; ?>" title="Borrar"><span class="icon-x"></span></a>
            <?php endif ?>
        </td>
   </tr>
   <?php endforeach ?>
